...
# v0.6.12 - mar/2020  by mountaineerbr
...
DESCRIPTION
	...
	convert any amount of one supported currency into another. Rates are re-
	trieved from openexchangerates.org with a free personal API key.
